...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption
				code="master.menu.anonymous.favourite-link-jorge"
				action="http://www.azuaga.es/" />
			<acme:menu-suboption code="master.menu.anonymous.favourite-link-fran"
				action="https://www.realbetisbalompie.es/" />
			<acme:menu-suboption
				code="master.menu.anonymous.favourite-link-francisco"
				action="http://bandalasnievesolivares.com/" />
			<acme:menu-suboption code="master.menu.anonymous.favourite-link-jose"
				action="https://keepa.com/" />
			<acme:menu-suboption
				code="master.menu.anonymous.favourite-link-alberto"
		...
		<acme:menu-option code="master.menu.any.useraccount">
			<acme:menu-suboption code="master.menu.any.useraccount.consumer"
				action="/any/user-account/list?role=consumer" />
			<acme:menu-suboption code="master.menu.any.useraccount.inventor"
				action="/any/user-account/list?role=inventor" />
			<acme:menu-suboption code="master.menu.any.useraccount.patron"
				action="/any/user-account/list?role=patron" />
			<acme:menu-suboption code="master.menu.any.useraccount.provider"
				action="/any/user-account/list?role=provider" />
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.inventor"
			...
			<acme:menu-suboption code="master.menu.inventor.patronageReport.list"
